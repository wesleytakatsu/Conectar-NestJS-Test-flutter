...
class CompanyRegisterCard extends StatefulWidget {
  ...
  @override
  CompanyRegisterCardState createState() => CompanyRegisterCardState();
}

class CompanyRegisterCardState extends State<CompanyRegisterCard> {
